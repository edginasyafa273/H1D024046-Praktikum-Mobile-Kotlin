package com.pemmob.edginasyafa.data.dummy

import com.pemmob.edginasyafa.data.model.Category
...
object DummyData {
    ...
    val products = listOf(
        ...
        Product(2, 1, categories[0], "Mendoan", "Mendoan khas Purwokerto", 20000.0, 30, "dummy_product"),
        ...
        Product(7, 2, categories[1], "Kopi Robusta", "Kopi bubuk", 15000.0, 50, "dummy_product"),
        Product(8, 2, categories[1], "Wedang Jahe", "Jahe anget", 12000.0, 50, "dummy_product"),
        ...
        Product(12, 3, categories[2], "Sandal Bambu", "Sandal anyaman", 40000.0, 25, "dummy_product"),
